...
export interface FormProps extends NodeProps<HTMLFormElement> {
    ...
    * |  **Yes**  | **Yes**  |   **Yes**   | **Yes** |
    *
    Example: <form      action="\/action_page.php"     method="get">   <label for="fname">First name:<\/label>  <input type="text" id="fname"      name="fname"><br><br>  <label for="lname">Last name:<\/label>       <input type="text" id="lname" name="lname"><br><br>  <input      type="submit" value="Submit"><\/form>
    *
    ...
    * |  **Yes**  | **4.0**  |   **5.2**   | **Yes** |
    *
    Example: <form action="\/action_page.php" method="get" autocomplete="on">    <label for="fname">First name:<\/label>  <input type="text" id="fname"      name="fname"><br><br>  <label for="email">Email:<\/label>       <input type="text" id="email" name="email"><br><br>  <input      type="submit">  <\/form>
    *
    ...
    * |  **Yes**  | **Yes**  |   **Yes**   | **Yes** |
    *
    Example: <form action="\/action_page_binary.asp"  method="post" enctype="multipart\/form-data">   <label for="fname">First name:<\/label>  <input type="text" id="fname"      name="fname"><br><br>  <label for="lname">Last name:<\/label>       <input type="text" id="lname" name="lname"><br><br>  <input      type="submit" value="Submit">  <\/form>
    *
  ...
  */
    ...
    * |  **Yes**  | **Yes**  |   **Yes**   | **Yes** |
    *
    Example: <form      action="\/action_page.php"     method="get" name="myForm">   <label for="fname">First name:<\/label>  <input type="text" id="fname"      name="fname"><br><br>  <label for="lname">Last name:<\/label>       <input type="text" id="lname" name="lname"><br><br>  <input      type="button" onclick="formSubmit()" value="Send form data!">     <\/form>
    *
    ...
    * |  **Yes**  | **4.0**  |   **10.1**   | **10.0** |
    *
    Example: <form action="\/action_page.php" novalidate>    <label for="email">Enter your email:<\/label>  <input      type="email" id="email" name="email"><br><br>  <input      type="submit">  <\/form>
    *
  ...
  */
    ...
    * |  **Yes**  | **Yes**  |   **Yes**   | **Yes** |
    *
    Example: <form action="\/action_page.php"     method="get" target="_blank">   <label for="fname">First name:<\/label>  <input type="text" id="fname"      name="fname"><br><br>  <label for="lname">Last name:<\/label>       <input type="text" id="lname" name="lname"><br><br>  <input      type="submit" value="Submit">     <\/form>
    *
