...
export interface FieldsetProps extends NodeProps<HTMLElement> {
    ...
    * |  **Yes**  | **Yes**  |   **6.0**   | **Yes** |
    *
    Example: `<form action="/action_page.php">  <fieldset disabled>
    ...
    * |  **Yes**  | **Yes**  |   **Yes**   | **Yes** |
    *
    Example: `<form action="/action_page.php" method="get" id="form1">  <label
        for="favcolor">What is your favorite color?</label>  <input
        type="text" id="favcolor" name="favcolor">  <input type="submit">
        </form><fieldset form="form1">  <legend>Personalia:</legend>
        <label for="fname">First name:</label>  <input type="text" id="fname"
        name="fname" form="form1"><br><br>  <label for="lname">Last name:</label>
    ...
    * |  **Yes**  | **Yes**  |   **Yes**   | **11.0** |
    *
    Example: `<form action="/action_page.php" method="get">  <fieldset name="personalia">
        <label for="fname">First name:</label>    <input
        type="text" id="fname" name="fname">  </fieldset>  <br>
        <button type="button"  onclick="form.personalia.style.backgroundColor='yellow'">
        Change background color of fieldset</button>  <input type="submit">
        </form>`
    *
...
*/
export declare class Fieldset extends GlobalDom<HTMLElement> {
