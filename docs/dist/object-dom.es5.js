...
var ObjectDom = /** @class */ (function () {
    function ObjectDom() {
        var _this = this;
        this.build = function () { return _this.render().build(); };
        this.render = function () { return _this; };
        this.update = function () { };
        this.toHtml = function (root) { return _this.build().outerHTML; };
    }
    return ObjectDom;
}());
var GlobalDom = /** @class */ (function (_super) {
    ...
    function GlobalDom(props) {
        ...
        _this.build = function () { return _this.node; };
...
var Input = /** @class */ (function (_super) {
    ...
    function Input(props) {
        ...
        _this.type = new NodeAttr(_this, 'type', props === null || props === void 0 ? void 0 : props.type);
        _this.name = new NodeAttr(_this, 'name', props === null || props === void 0 ? void 0 : props.type);
        _this.required = new NodeAttr(_this, 'required', props === null || props === void 0 ? void 0 : props.type);
        return _this;
    }
...
var Link = /** @class */ (function (_super) {
    ...
    function Link(props) {
        ...
        _this.as = new NodeAttr(_this, 'as', props.as);
        _this.crossorigin = new NodeAttr(_this, 'crossorigin', props.crossorigin);
        _this.disabled = new NodeAttr(_this, 'disabled', props.disabled);
        _this.href = new NodeAttr(_this, 'href', props.href);
        return _this;
    }
    return Link;
}(GlobalDom));
...
var Meta = /** @class */ (function (_super) {
    ...
    function Meta(props) {
        ...
        _this.charset = new NodeAttr(_this, 'charset', props.charset);
        _this.content = new NodeAttr(_this, 'content', props.content);
        _this.httpEquiv = new NodeAttr(_this, 'http-equiv', props.httpEquiv);
        _this.name = new NodeAttr(_this, 'name', props.name);
        return _this;
    }
    return Meta;
}(GlobalDom));
...
var Math = /** @class */ (function (_super) {
    ...
    function Math(props) {
        ...
        _this.href = new NodeAttr(_this, 'href', props === null || props === void 0 ? void 0 : props.href);
        _this.mathbackground = new NodeAttr(_this, 'mathbackground', props === null || props === void 0 ? void 0 : props.mathbackground);
        _this.mathcolor = new NodeAttr(_this, 'mathcolor', props === null || props === void 0 ? void 0 : props.mathcolor);
        _this.display = new NodeAttr(_this, 'display', props === null || props === void 0 ? void 0 : props.display);
        return _this;
    }
    return Math;
}(GlobalDom));
...
var Svg = /** @class */ (function (_super) {
    ...
    function Svg(props) {
        ...
        _this.viewbox = new NodeAttr(_this, 'viewbox', props === null || props === void 0 ? void 0 : props.viewbox);
        _this.preserveAspectRatio = new NodeAttr(_this, 'preserve-aspect-ratio', props === null || props === void 0 ? void 0 : props.preserveAspectRatio);
        _this.weight = new NodeAttr(_this, 'weight', props === null || props === void 0 ? void 0 : props.weight);
        _this.height = new NodeAttr(_this, 'height', props === null || props === void 0 ? void 0 : props.height);
        _this.x = new NodeAttr(_this, 'x', props === null || props === void 0 ? void 0 : props.x);
        _this.y = new NodeAttr(_this, 'y', props === null || props === void 0 ? void 0 : props.y);
        return _this;
    }
    return Svg;
}(GlobalDom));
...
export { Base, Block, Body, Bold, Break, Button, Caption, Cell, Column, Custom, Deleted, Div, Emphasized, Flex, Form, GlobalDom, Grid, Head, HeaderCell, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6, Html, Inline, InlineBlock, Input, InputGroup, Inserted, Italic, Label, Link, Marked, Math, Meta, ObjectDom, Paragraph, Row, Script, Smaller, Span, Strong, Style, Subscript, Superscript, Svg, Table, TableBody, TableColumn, TableColumnGroup, TableFooter, TableHeader, TableRow, Template, Text, Title, Wrap, convertClassList, convertCssStyles, create, jsonTable, render };
